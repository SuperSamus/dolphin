                                            ...
                                            u64 full_hash)
{
  ...
  TextureConfig new_config = existing_entry->texture->GetConfig();
  new_config.width = new_config.width * new_native_width / existing_entry->ActualWidth();
  new_config.height = new_config.height * new_native_height / existing_entry->ActualHeight();
...
u32 TCacheEntry::ActualHeight() const
{
