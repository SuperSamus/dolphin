...
public:
  ...
  bool TryPrepareInBlockBranches(const PPCAnalyst::CodeOp& op, const BitSet32 locked_gprs = {});
  ...
  // TODO: Remove locked_gprs after redesigning downcount management
  TryInBlockBranch(const PPCAnalyst::CodeOp& op, const BitSet32 locked_gprs = {});
